...
public class change_password extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cur_pwd = (EditText) findViewById(R.id.editTextTextPersonName12);
        new_pwd = (EditText) findViewById(R.id.editTextTextPersonName19);
        confirm_pwd = (EditText) findViewById(R.id.editTextTextPersonName37);
