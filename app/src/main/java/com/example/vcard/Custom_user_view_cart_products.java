...
public class Custom_user_view_cart_products extends BaseAdapter {

    String[] cart_id,product_name,quantity,image,pprice;

    private Context context;

    public Custom_user_view_cart_products(Context appcontext,String[]product_id,String[]product_name,String[]quantity,String[]image,String[]price)
    {
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                        ...
                                        Intent ij = new Intent(context, User_view_cart.class);
