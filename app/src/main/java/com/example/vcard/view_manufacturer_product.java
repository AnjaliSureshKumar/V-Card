...
public class view_manufacturer_product extends AppCompatActivity {
    ListView l;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_manufacturer_product);
        ...
        String url = "http://" + hu + ":5000/view_manufacturer_product";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                l.setAdapter(new custom_view_manufacturer_product(getApplicationContext(),image,product_name,price,quantity,brand_name));
