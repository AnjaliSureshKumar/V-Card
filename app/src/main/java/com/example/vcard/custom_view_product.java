...
public class custom_view_product extends BaseAdapter  {
    ...
    public custom_view_product(Context appcontext,String[]image,String[]product_id,String[]product_name,String[]price,String[]quantity,String[]type,String[]made_id,String[]brand_name) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        ImageView imdelete=(ImageView) gridView.findViewById(R.id.delete);
        imdelete.setTag(i);
