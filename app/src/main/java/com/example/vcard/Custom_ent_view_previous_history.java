...
public class Custom_ent_view_previous_history extends BaseAdapter {

    String[]seller_name,total,date,oid;
    private Context context;
    public Custom_ent_view_previous_history(Context appcontext, String[]seller_name,String[]total,String[]date,String[]oid) {
