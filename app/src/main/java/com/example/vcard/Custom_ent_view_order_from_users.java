...
public class Custom_ent_view_order_from_users extends BaseAdapter {
    String[]uname,uphone,ordermount,orderdate,oid;
    private Context context;
    public Custom_ent_view_order_from_users(Context appcontext, String[]uname,String[]uphone,String[]ordermount,String[]orderdate,String[]oid) {
    ...
    public View getView(int i, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            gridView = inflator.inflate(R.layout.custom_ent_view_order_from_users, null);
