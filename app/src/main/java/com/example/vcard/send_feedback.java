...
public class send_feedback extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send_feedback = (TextView) findViewById(R.id.textView28);
        feedback = (EditText) findViewById(R.id.editTextTextMultiLine2);
    ...
    public void onClick(View view) {
        ...
        if (Feedback.length()==0){
            ...
            String url = "http://" + hu + ":5000/send_feedback";
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                    ...
                                    Intent i = new Intent(getApplicationContext(), customer_homepage.class);
                                    startActivity(i);
