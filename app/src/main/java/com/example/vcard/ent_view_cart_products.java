...
public class ent_view_cart_products extends AppCompatActivity implements View.OnClickListener {
    ListView viewcart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ent_view_cart_products);
...
//        buy.setOnClickListener(this);
        ...
        url = "http://" + hu + ":5000/ent_view_cart_product";
//        url1 = "http://" + hu + ":5005/buy_product";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                viewcart.setAdapter(new Custom_ent_view_cart_product(getApplicationContext(),cart_id,product_name,quantity,image,price));
    ...
    public void onClick(View v) {
        startActivity(new Intent(getApplicationContext(),ent_paymennt.class));
    }
}