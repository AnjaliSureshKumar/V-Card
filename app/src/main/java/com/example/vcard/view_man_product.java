...
public class view_man_product extends AppCompatActivity {
    ListView lv;
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(getApplicationContext(),manufacturer_homepage.class));
    }
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view_man_product);
        lv = (ListView) findViewById(R.id.listView1);


        SharedPreferences sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        String hu = sh.getString("ip", "");
        String url = "http://" + hu + ":5000/view_man_product";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                lv.setAdapter(new custom_view_man_product(getApplicationContext(),image,product_id,product_name,price,quantity,type,made_id,brand_name));
