...
public class view_product_man extends AppCompatActivity {
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_product_man);
        lv = (ListView) findViewById(R.id.listView5);


        SharedPreferences sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        String hu = sh.getString("ip", "");
        String url = "http://" + hu + ":5000/view_man_more";
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                lv.setAdapter(new custom_view_product_man(getApplicationContext(),image,product_id,product_name,price,quantity,brand_name));
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("manufacturer_login_id",sh.getString("manufacturer_login_id",""));
