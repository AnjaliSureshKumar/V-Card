...
public class ent_send_rate_review_manuf extends AppCompatActivity {
    RatingBar rating;
    EditText edreview;
    Button btsubmit;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ent_send_rate_review_manuf);
        ...
        btsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String url = "http://" + hu + ":5000/user_reviewsadd";
                ...
                StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                    ...
                    protected Map<String, String> getParams() {
                        ...
                        params.put("shopid", sh.getString("manufacturer_login_id",""));
                        params.put("totype", "to_manuf");
