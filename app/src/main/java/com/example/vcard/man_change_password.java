...
public class man_change_password extends AppCompatActivity implements View.OnClickListener {
    EditText cur_pwd;
    EditText new_pwd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.man_change_password);
        cur_pwd = (EditText) findViewById(R.id.editTextTextPersonName41);
        new_pwd = (EditText) findViewById(R.id.editTextTextPersonName42);
        confirm_pwd = (EditText) findViewById(R.id.editTextTextPersonName43);
    ...
    public void onClick(View view) {
        ...
        if (current_password.length()==0){
            ...
            String url = "http://" + hu + ":5000/man_change_password";
