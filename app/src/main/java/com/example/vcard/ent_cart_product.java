...
public class ent_cart_product extends AppCompatActivity implements View.OnClickListener {
    EditText ed1;
    Button b1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ent_cart_product);
    ...
    public void onClick(View v) {
        ...
        if (bb > aa) {
            ...
            ed1.setError("Enter Quantity");
                ...
                String url = "http://" + hu + ":5000/ent_add_to_cart";
                ...
                StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                        ...
                                        Toast.makeText(ent_cart_product.this, "Order taken", Toast.LENGTH_SHORT).show();
                    ...
                    protected Map<String, String> getParams() {
                        ...
                        params.put("owlid", sh.getString("manufacturer_login_id", ""));
